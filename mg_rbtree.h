...
static inline mg_bool_t rb_node_is_red(mg_rb_node_t* node) {
    return node->_type == RBREDNODE;
}

static inline mg_bool_t rb_node_is_black(mg_rb_node_t* node) {
    return node->_type == RBBLACKNODE;
}

static inline void init_rb_node(mg_rb_node_t* rbnode) {
    rbnode->_type = RBREDNODE;
    rbnode->_parent = rbnode->_lchild = rbnode->_rchild = nullptr;
}

static inline void init_rb_tree(mg_rbtree_t* rbtree,
...
static inline mg_rb_node_t* search_rb_node(mg_rb_node_t* node, mg_rbtree_t* tree,
...
//
static inline void left_rotate(mg_rb_node_t* node, mg_rbtree_t* tree) {
...
//
static inline void right_rotate(mg_rb_node_t* node, mg_rbtree_t* tree) {
    mg_rb_node_t* p = node->_parent;
...
static inline void delete_leaf_node(mg_rb_node_t* leaf, mg_rbtree_t* tree) {
    if (leaf == tree->_root) {
        tree->_root = nullptr;
        return;
    }
...
static inline void change_rb_node(mg_rb_node_t* n1, mg_rb_node_t* n2,
                                  mg_rbtree_t* tree, bool change_type) {
    if (n1 == n2) return;
...
static inline mg_rb_node_t* find_right_replace_node(mg_rb_node_t* n) {
...
static inline void insert_rb_node(mg_rb_node_t* node, mg_rbtree_t* tree) {
...
static inline void delete_rb_node(mg_rb_node_t* dnode, mg_rbtree_t* tree) {
